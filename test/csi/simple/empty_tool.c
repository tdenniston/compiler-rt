...
extern "C" void __ok_before_store1(void *addr, int attr) {
    fprintf(stderr, "Before store1, addr %p.\n", addr);
}
extern "C" void __ok_before_store2(void *addr, int attr) {
    fprintf(stderr, "Before store2, addr %p.\n", addr);
}
extern "C" void __ok_before_store4(void *addr, int attr) {
    fprintf(stderr, "Before store4, addr %p.\n", addr);
}
extern "C" void __ok_before_store8(void *addr, int attr) {
    fprintf(stderr, "Before store8, addr %p.\n", addr);
}
// void __ok_before_float(void *addr, int attr) {}
// void __ok_before_double(void *addr, int attr) {}
