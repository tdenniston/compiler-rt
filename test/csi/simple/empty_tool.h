...
void __ok_after_load1(void *addr, int attr);
void __ok_after_load2(void *addr, int attr);
void __ok_after_load4(void *addr, int attr);
void __ok_after_load8(void *addr, int attr);
// void __ok_after_float(void *addr, int attr);
// void __ok_after_double(void *addr, int attr);
void __ok_before_store1(void *addr, int attr);
void __ok_before_store2(void *addr, int attr);
